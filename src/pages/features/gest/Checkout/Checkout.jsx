...
import { getGuestCart, mergeGuestCartWithUserCart } from 'utils/guestCart';
...
function Checkout() {
  ...
  const inputSx = {
    '& .MuiOutlinedInput-root': {
      ...
      '&.Mui-focused fieldset': { borderColor: '#f0a500', borderWidth: 2 }
    }
  };
  ...
  return (
    <AuthGuard>
      <Box sx={{ bgcolor: '#f3f3f3', minHeight: '100vh', py: 3 }}>
        <Container maxWidth="lg">
          ...
          <Grid container spacing={2} alignItems="flex-start">
            ...
            <Grid item xs={12} md={8}>
              {/* ── Step 1: Shipping ── */}
              <Paper elevation={0} sx={{ border: '1px solid #ddd', borderRadius: 1, p: 3, mb: 2 }}>
                <Stack direction="row" alignItems="center" spacing={1} mb={2}>
                  <LocalShippingOutlinedIcon sx={{ color: '#f0a500' }} />
                ...
                <Box sx={{ mb: 2 }}>
                  <TextField
                    ...
                    helperText={
                      validationErrors.governorate || (loadingGovernorates ? 'Loading governorates...' : 'This field is required')
                    }
                    sx={inputSx}
                  >
                    <MenuItem value="">
              ...
              <Paper elevation={0} sx={{ border: '1px solid #ddd', borderRadius: 1, p: 3, mb: 2 }}>
                <Stack direction="row" alignItems="center" spacing={1} mb={2}>
                  <CreditCardIcon sx={{ color: '#f0a500' }} />
                  <Typography variant="h6" fontWeight={700} color="#0f1111">
                  ...
                  <RadioGroup value={paymentMethod} onChange={(e) => setPaymentMethod(e.target.value)}>
                    ...
                    {/* <Box
                      ...
                      sx={{
                        ...
                        mb: 1.5,
                        borderRadius: 1,
                        border: paymentMethod === 'cib_bank' ? '2px solid #f0a500' : '1px solid #ddd',
                    ...
                    >
                      <Radio
                        value="cib_bank"
                        size="small"
                        sx={{ p: 0, mt: '2px', color: '#f0a500', '&.Mui-checked': { color: '#f0a500' } }}
                      />
                      <Box>
            ...
            <Grid item xs={12} md={4}>
              <Paper elevation={0} sx={{ border: '1px solid #ddd', borderRadius: 1, p: 2.5, position: 'sticky', top: 16 }}>
                ...
                >
                  <FormattedMessage id="back-to-cart" />
                </Button>
              </Paper>
            </Grid>
          </Grid>
